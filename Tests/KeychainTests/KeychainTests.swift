...
class KeychainTests: XCTestCase {
    ...
    override func setUp() {
        ...
        secureStoreWithGenericPwd = SecureStore(genericPwdQueryable)
        ...
        secureStoreWithInternetPwd = SecureStore(internetPwdQueryable)
    }
    ...
    func testRemoveAllInternetPasswords() {
        do {
            ...
            try secureStoreWithInternetPwd.setValue("pwd_1239", for: "internetPassword3")
            try secureStoreWithInternetPwd.removeAllValues()
            XCTAssertNil(try secureStoreWithInternetPwd.getValue(for: "internetPassword"))
            XCTAssertNil(try secureStoreWithInternetPwd.getValue(for: "internetPassword2"))
            XCTAssertNil(try secureStoreWithInternetPwd.getValue(for: "internetPassword3"))
        } catch (let e) {
